...
import com.example.firebase.view.viewmodel.HomeViewModel
import com.example.firebase.view.viewmodel.PenyediaViewModel
import com.example.firebase.view.viewmodel.StatusUiSiswa
        ...
        items(items = itemSiswa, key = { it.id }) { person ->
            ItemSiswa(
                ...
                modifier = Modifier
                    ...
                    .clickable { onSiswaClick(person.id.toInt()) }
            )
        }
    }
}
